            ...
            return (
              ...
              >
                ...
                <div className="flex min-w-0 items-start gap-3">
                  <div
                    className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border text-xs font-bold uppercase ${STATUS_COLORS[r.status]}`}
                  >
                    {r.guestName[0]}
                  </div>
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <p className="text-foreground text-sm font-semibold">{r.guestName}</p>
                      <span
                    ...
                    {r.notes && (
                      <p className="text-muted-foreground mt-1.5 flex items-start gap-1 text-xs italic">
