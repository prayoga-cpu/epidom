      ...
      <div className="epi-container">
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
          ...
          <div>
            ...
            >
              {t("redesign.setup.title1")}
              <br />
              {t("redesign.setup.title2")}
              <br />
              {t("redesign.setup.title3")}
              <br />
              <span style={{ color: "var(--epi-gold-600)" }}>
                {t("redesign.setup.titleAccent")}
              </span>
            </h2>
            <p
              style={{
                color: "var(--epi-navy-700)",
                fontSize: 16,
                lineHeight: 1.6,
                marginTop: 22,
                maxWidth: 400,
            ...
            {steps.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  border: "1px solid rgba(6,15,27,0.08)",
                  display: "grid",
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ color: "var(--epi-navy-700)", fontSize: 14, lineHeight: 1.6 }}>
                    {s.body}
                  </div>
                </div>
              </div>
