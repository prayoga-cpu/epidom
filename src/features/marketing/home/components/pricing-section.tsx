...
export function PricingSection() {
  ...
  const tiers = [
    {
      tag: t("redesign.pricingTeaser.t1tag"),
      name: t("redesign.pricingTeaser.t1name"),
      price: t("redesign.pricingTeaser.t1price"),
      period: t("redesign.pricingTeaser.t1period"),
      desc: t("redesign.pricingTeaser.t1desc"),
      highlight: false,
    },
    {
      tag: t("redesign.pricingTeaser.t2tag"),
      name: t("redesign.pricingTeaser.t2name"),
    ...
    },
    {
      ...
      name: t("redesign.pricingTeaser.t3name"),
    ...
    },
    {
      ...
      name: t("redesign.pricingTeaser.t4name"),
      price: t("redesign.pricingTeaser.t4price"),
      period: t("redesign.pricingTeaser.t4period"),
      desc: t("redesign.pricingTeaser.t4desc"),
      highlight: false,
    },
  ];
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, transparent, rgba(11,26,40,0.5))" }}
    >
        ...
        >
          <div>
            <div className="epi-eyebrow" style={{ marginBottom: 16 }}>
              {t("redesign.pricingTeaser.eyebrow")}
            </div>
            <h2
            ...
            >
              {t("redesign.pricingTeaser.title1")}
              <br />
            ...
            >
              <div
                style={{
                  ...
                  textTransform: "uppercase",
                  color: tier.highlight ? "var(--epi-gold-300)" : "var(--epi-cream-50)",
              ...
              <div
                className="epi-display"
                style={{ fontSize: 32, letterSpacing: "0.04em", color: "var(--epi-cream-50)" }}
              >
                {tier.name}
              </div>
              <div>
              ...
              <div
                style={{
                  marginTop: "auto",
                  color: tier.highlight ? "var(--epi-gold-400)" : "var(--epi-cream-50)",
                  fontSize: 12,
