...
export function DashboardPreviewSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, transparent, rgba(11,26,40,0.4) 50%, transparent)" }}
    >
      <div className="epi-container">
        {/* Heading */}
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto" }}>
          <div className="epi-eyebrow" style={{ marginBottom: 16 }}>{t("redesign.dashboard.eyebrow")}</div>
          <h2
            className="epi-display"
            style={{ fontSize: "clamp(40px, 5vw, 72px)", margin: 0, lineHeight: 0.95, color: "var(--epi-cream-50)" }}
          >
            {t("redesign.dashboard.title1")}<br />
        ...
        <div style={{ marginTop: 56, position: "relative" }}>
          <div style={{ position: "absolute", inset: -40, background: "radial-gradient(circle, rgba(217,174,59,0.16), transparent 60%)", filter: "blur(40px)", zIndex: -1 }} />
          <PosDashboard />
        </div>
      </div>
    </section>
