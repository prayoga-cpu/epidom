      ...
      <div className="epi-container">
        ...
        <div style={{ textAlign: "center", maxWidth: 720, margin: "0 auto" }}>
          <div className="epi-eyebrow" style={{ marginBottom: 16 }}>
            {t("redesign.coreProducts.eyebrow")}
          </div>
          <h2
          ...
          >
            {t("redesign.coreProducts.title1")}
            <br />
        ...
        <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div
                style={{
                  ...
                  height: 40,
                  borderRadius: 12,
                  background: "rgba(217,174,59,0.18)",
            ...
            <div>
              ...
              >
                {t("redesign.coreProducts.p1title1")}
                <br />
                {t("redesign.coreProducts.p1title2")}
              </div>
              <p
                style={{
                  color: "var(--epi-cream-50)",
              ...
              >
                {t("redesign.coreProducts.p1body")}
              </p>
            </div>
          ...
          >
            ...
            <div style={{ position: "relative", display: "flex", alignItems: "center", gap: 10 }}>
              <div
                style={{
                  ...
                  height: 40,
                  borderRadius: 12,
                  background: "rgba(217,174,59,0.20)",
                  border: "1px solid rgba(217,174,59,0.40)",
                  display: "grid",
                  placeItems: "center",
                  color: "var(--epi-gold-300)",
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                {t("redesign.coreProducts.p2title1")}
                <br />
                {t("redesign.coreProducts.p2title2")}
              </div>
              <p
                style={{
                  color: "var(--epi-cream-50)",
              ...
              >
                {t("redesign.coreProducts.p2body")}
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    {t("redesign.coreProducts.p2orderName")}
                  </div>
                  <div style={{ fontSize: 14, color: "var(--epi-cream-50)", fontWeight: 600 }}>
                    {t("redesign.coreProducts.p2orderVal")}
                  </div>
                </div>
                <div
                  style={{
              ...
              >
                ...
                <span style={{ color: "var(--epi-gold-400)" }}>
                  {t("redesign.coreProducts.p2settled")}
                </span>
              </div>
            </div>
          </div>
          ...
          <div
            style={{
              ...cardBase,
              background: "linear-gradient(180deg, rgba(91,136,178,0.10), rgba(91,136,178,0.02))",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div
                style={{
                  ...
                  height: 40,
                  borderRadius: 12,
                  background: "rgba(91,136,178,0.20)",
                  border: "1px solid rgba(91,136,178,0.40)",
                  display: "grid",
                  placeItems: "center",
            ...
            <div>
              ...
              >
                {t("redesign.coreProducts.p3title1")}
                <br />
                {t("redesign.coreProducts.p3title2")}
              </div>
              <p
                style={{
                  color: "var(--epi-cream-50)",
              ...
              >
                {t("redesign.coreProducts.p3body")}
              </p>
            </div>
            <div style={{ flex: 1, display: "grid", placeItems: "center", minHeight: 280 }}>
              <PhoneKDS />
