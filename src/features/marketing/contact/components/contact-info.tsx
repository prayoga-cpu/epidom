  ...
  return (
    <div className="flex items-start gap-4 md:gap-6 lg:gap-4">
      <div className="mt-1 flex-shrink-0">
        <Icon className="h-5 w-5 md:h-6 md:w-6 lg:h-5 lg:w-5 text-brand-primary" />
      </div>
      ...
      <div className="space-y-6 md:space-y-8 lg:space-y-5">
          <ContactItem icon={MapPin} label={t("contact.labels.address")}>
            <div className="space-y-1 md:space-y-1.5 lg:space-y-1">
              <p className="text-sm leading-relaxed md:text-lg lg:text-base text-brand-primary">
          ...
          <ContactItem icon={Phone} label={t("contact.labels.phone")}>
            <a
              ...
              className="block text-sm leading-relaxed transition-opacity hover:opacity-70 md:text-lg lg:text-base text-brand-primary"
            >
