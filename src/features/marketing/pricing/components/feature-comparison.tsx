...
const CATEGORIES = [
  {
    ...
    rows: [
      ...
      {
        labelKey: "redesign.pricingPage.cmp_branding",
        free: true,
        pos: true,
        ops: true,
        ent: true,
      ...
      {
        labelKey: "redesign.pricingPage.cmp_multilingual",
        free: true,
        pos: true,
        ops: true,
        ent: true,
  ...
  },
  {
    ...
    rows: [
      {
        labelKey: "redesign.pricingPage.cmp_phone_pos",
        free: false,
        pos: true,
        ops: true,
        ent: true,
      ...
      {
        labelKey: "redesign.pricingPage.cmp_thermal",
        free: false,
        pos: true,
        ops: true,
        ent: true,
  ...
  },
  {
    ...
    rows: [
      ...
      {
        labelKey: "redesign.pricingPage.cmp_recipes",
        free: false,
        pos: false,
        ops: true,
        ent: true,
  ...
  return (
    ...
    >
      <circle
        ...
        cy="9"
        r="8.5"
        fill="rgba(217,174,59,0.14)"
        stroke="rgba(217,174,59,0.28)"
        strokeWidth="0.5"
      />
      <path
