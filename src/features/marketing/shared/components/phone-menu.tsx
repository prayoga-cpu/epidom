  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ display: "flex", gap: 4, alignItems: "center" }}>
            <svg width="14" height="9" viewBox="0 0 14 9" aria-hidden="true">
              <path d="M0 7h2v2H0zm3-1.5h2V9H3zm3-1.5h2v5H6zm3-1.5h2v6.5H9zm3-1.5h2v8h-2z" fill="#1a1a1a" />
            </svg>
        ...
        {/* Banner */}
        <div style={{
          margin: "8px 14px 0", borderRadius: 16, height: 110,
          background: "linear-gradient(135deg, var(--epi-navy-700), var(--epi-navy-900))",
          position: "relative", overflow: "hidden",
          display: "flex", alignItems: "flex-end",
          padding: 14, color: "var(--epi-cream-50)",
        }}>
          <div style={{
            position: "absolute", inset: 0,
            background: "linear-gradient(0deg, rgba(6,15,27,0.95) 0%, rgba(6,15,27,0.5) 60%, rgba(6,15,27,0.3) 100%)",
          }} />
          <div style={{ position: "relative", zIndex: 2 }}>
            <div style={{ fontFamily: "var(--epi-font-display)", fontSize: 18, letterSpacing: "0.08em", lineHeight: 1 }}>
              WARUNG SARI
            </div>
            <div style={{ fontSize: 10, color: "var(--epi-cream-100)", marginTop: 4, opacity: 0.9 }}>
        ...
        {/* Menu items */}
        <div style={{ padding: "8px 14px", display: "flex", flexDirection: "column", gap: 10, flex: 1, overflow: "hidden" }}>
          {[
            ...
            <div key={i} style={{ display: "flex", gap: 10, alignItems: "center" }}>
              ...
              <div style={{
                ...
                background: "var(--epi-navy-900)", color: "var(--epi-cream-50)",
                display: "grid", placeItems: "center", fontSize: 12, lineHeight: 1, paddingBottom: 1,
              }}>+</div>
            </div>
          ))}
        </div>
        ...
        {/* Cart bar */}
        <div style={{
          margin: "8px 14px 16px", padding: "10px 14px", borderRadius: 14,
          background: "var(--epi-navy-900)", color: "var(--epi-cream-50)",
          display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8,
        }}>
          <div style={{ minWidth: 0, flex: "0 1 auto" }}>
            <div style={{ fontSize: 9, opacity: 0.5, letterSpacing: "0.10em", textTransform: "uppercase" }}>2 items</div>
          ...
          <div style={{
            ...
            fontSize: 9, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", whiteSpace: "nowrap",
          }}>
            Pay QRIS →
          </div>
        </div>
        ...
        <div style={{
          ...
          width: 100, height: 4, borderRadius: 2, background: "#1a1a1a",
        }} />
      </div>
    </div>
  );
