            ...
            <div className="flex min-h-0 flex-1 flex-col gap-3">
              ...
              <div className="flex shrink-0 flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder={
                      t("management.delivery.searchPlaceholder") ||
                      "Search by reference, supplier, or notes..."
                    }
                    value={searchQuery}
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    ...
                    <SelectContent>
                      <SelectItem value="all">
                        {t("management.delivery.filters.allStatuses") || "All Statuses"}
                      </SelectItem>
                      <SelectItem value="pending">
                        {t("management.delivery.status.pending") || "Pending"}
                      </SelectItem>
                      <SelectItem value="in_transit">
                        {t("management.delivery.status.inTransit") || "In Transit"}
                      </SelectItem>
                      <SelectItem value="received">
                        {t("management.delivery.status.received") || "Received"}
                      </SelectItem>
                      <SelectItem value="cancelled">
                        {t("management.delivery.status.cancelled") || "Cancelled"}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  ...
                  <Select value={typeFilter} onValueChange={setTypeFilter}>
                    ...
                    <SelectContent>
                      <SelectItem value="all">
                        {t("management.delivery.filters.allTypes") || "All Types"}
                      </SelectItem>
                      <SelectItem value="incoming">
                        {t("management.delivery.type.incoming") || "Incoming"}
                      </SelectItem>
                      <SelectItem value="outgoing">
                        {t("management.delivery.type.outgoing") || "Outgoing"}
                      </SelectItem>
                    </SelectContent>
                  </Select>
