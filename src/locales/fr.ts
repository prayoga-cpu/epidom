...
staffOwnerMasterHint: "Compte master — accès complet à toutes les fonctionnalités, toutes les pages, tous les paliers, toujours.",
  ...
  about: {
    ...
    stat1value: "500+",
    stat2label: "Commandes traitées",
    stat2value: "10k+/jour",
    stat3label: "Pays",
    stat3value: "20+",
    stat4label: "Note utilisateurs",
    stat4value: "4,9 ★",
    valuesEyebrow: "Ce en quoi nous croyons",
    v1title: "Calme par défaut",
    v1body:
      "Un bon logiciel ne crée pas de bruit. Epidom envoie un ping WhatsApp par commande et un e-mail par nuit. C'est tout.",
  ...
  redesign: {
    hero: {
      ...
      proof2Label: "Pays",
      proof3Val: "10k+",
      proof3Label: "Commandes / jour",
      proof4Val: "4.9",
      proof4Label: "Note utilisateurs",
    ...
    features: {
      ...
      f6body:
        "Ventes, coûts, top articles, clôture de caisse — par e-mail chaque soir, exportables PDF/CSV.",
      f6hint: "Résumés propriétaire-friendly",
      f7title: "WhatsApp business",
      f7body:
        "Notifications de commande, pings de prêt aux clients, diffusion de nouveaux menus — tout depuis un seul numéro.",
      f7hint: "API WA officielle",
    ...
    useCases: {
      ...
      cafe_stat1v: "+34%",
      cafe_stat1l: "commandes via lien IG",
      cafe_stat2v: "4 min",
      cafe_stat2l: "passation de service",
      cafe_quote:
        "« Les clients voient maintenant mon menu et commandent depuis Instagram. Mes commandes WhatsApp ont drastiquement chuté. »",
      ...
      restaurant_stat1l: "temps d'attente cuisine",
      restaurant_stat2v: "0",
      restaurant_stat2l: "tickets papier perdus",
      restaurant_quote:
        "« La mise en place a pris 10 minutes et j'ai pu partager le lien immédiatement. Le QR de paiement a fonctionné instantanément. »",
      restaurant_by: "Budi Santoso · Gérant de café, Yogyakarta",
      cookie_headline: "Pour le cookie bar qui vit ou meurt le week-end.",
      cookie_body:
        "Planning de fournée, comptage visiteurs, alertes rush et portail commandes grossistes pour les cafés du quartier.",
      cookie_stat1v: "+27%",
      cookie_stat1l: "CA week-end",
      cookie_stat2v: "−38%",
      cookie_stat2l: "gaspillage farine",
      cookie_quote:
        "« On cuisait 800, on jetait 200. Maintenant on cuit 720 et on est en rupture à 17h. Chaque week-end. »",
      ...
      warung_stat1v: "0",
      warung_stat1l: "écarts de caisse mystérieux",
      warung_stat2v: "Gratuit",
      warung_stat2l: "à vie, menu + commandes",
      warung_quote:
        "« Les rapports journaliers automatiques me disent exactement ce que j'ai gagné. Je calculais tout à la main avant. »",
    ...
    servicesPage: {
      ...
      r5body:
        "Ventes, coûts, top articles, clôture de caisse — par e-mail chaque soir, exportables PDF/CSV. Des synthèses claires que votre comptable appréciera.",
    ...
    pricingPage: {
      ...
      trialBarSub:
        "Pas de carte. On importe votre menu existant gratuitement. Annulez à tout moment, vos données partent avec vous.",
      ...
      t1f6: "Caisse + KDS",
      t1f7: "Recettes & Coûts matières",
      t1f8: "Dashboard multi-établissement",
      t2f1: "Tout le forfait Free",
      t2f2: "Caisse sur tout appareil",
      t2f3: "KDS cuisine",
      t2f4: "Gestion tables + QR",
      t2f5: "Impression reçus thermiques",
      t2f6: "Carte / espèces",
      t2f7: "Recettes & Coûts matières",
      t2f8: "Dashboard multi-établissement",
      t3f1: "Tout le forfait POS",
      t3f2: "Gestion staff & services",
      t3f3: "Recettes & moteur coûts matières",
      t3f4: "Stock auto + alertes",
      t3f5: "P&L journalier envoyé au propriétaire",
      t3f6: "Étiquettes allergènes & nutritionnelles",
      t3f7: "Portail commandes grossistes",
      t3f8: "Dashboard multi-établissement",
      t4f1: "Tout le forfait Opérations",
      t4f2: "Dashboard multi-établissement",
      t4f3: "Bibliothèque de recettes centralisée",
      t4f4: "Rapports financiers complets",
      t4f5: "API + Zapier + webhooks",
      t4f6: "SSO + rôles avancés",
      ...
      cmp_daily: "E-mail rapport journalier",
      cmp_multi: "Dashboard multi-établissement",
      cmp_api: "Accès API",
    },
  },
