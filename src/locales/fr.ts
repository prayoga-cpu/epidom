export const fr = {
  ...
  billing: {
    ...
    notStripeManaged: "Vous êtes sur l'offre gratuite — aucun moyen de paiement ni abonnement à gérer. Passez à une offre payante pour débloquer les fonctionnalités.",
    betaAccount: "Compte BETA — accès accordé par l'administrateur, sans moyen de paiement. Changez de plan instantanément.",
  ...
  import: {
    ...
    subtitle: "Importez vos anciennes données — un fichier CSV ou tableur directement dans votre tableau de bord, et notre IA mappe les colonnes pour vous.",
    steps: {
      upload: "Télécharger",
      analysis: "Analyse",
      preview: "Aperçu",
  ...
  publicOrder: {
    ...
    orderStatus: {
      ...
      qrisDesc: "Utilisez votre portefeuille électronique ou votre application bancaire (GoPay, OVO, Dana, BCA, etc.).",
      qrisAutoUpdate: "Le statut QRIS se met à jour automatiquement une fois le paiement effectué",
      ovoTitle: "Finaliser le paiement",
      ovoDesc: "Ouvrez votre application OVO et consultez la notification pour finaliser ce paiement.",
      ...
      ewalletDesc: "Vous devriez être redirigé vers la page de paiement. Si vous n'avez pas payé, veuillez réessayer de commander.",
    ...
    checkoutForm: {
      ...
      addressPlaceholder: "Indiquez votre adresse de livraison complète avec des points de repère...",
