export const en = {
  ...
  home: {
    ...
    whatYouGet: {
      ...
      subheadline: "Customers open your link → view menu → order → pay with QRIS. You get a WhatsApp notification. Done.",
      feature1Title: "Menu Page",
      feature1Desc: "QR code + shareable link to IG story. Customers can view the menu and order anytime.",
    ...
    featureLadder: {
      ...
      subheadline: "From small cafés to franchise chains — there's a plan for every stage of your business.",
      popular: "Popular",
    ...
    testimonials: {
      ...
      t1Quote: "Customers can now view my menu and order from Instagram. My WhatsApp orders dropped massively!",
      t2Name: "Budi Santoso",
      t2Role: "Café Owner, Yogyakarta",
      t2Quote: "Setup took 10 minutes and I could immediately share the link with customers. QRIS worked instantly.",
      t3Name: "Rina Kusuma",
      t3Role: "Home Restaurant, Surabaya",
      t3Quote: "Automatic daily reports tell me exactly how much I made each day. I used to calculate manually.",
      ratingBadge: "4.9★ from Epidom users",
    },
    painGain: {
      headline: "The old way is frustrating. The new way is calm.",
      description:
        "See how Epidom replaces the manual chaos with one simple platform.",
      oldWay: {
  ...
  services: {
    ...
    tiers: {
      ...
      free: { name: "FREE", tagline: "Storefront & Online Orders", price: "$0", cta: "Get Started Free" },
      pos: { name: "POS", tagline: "Cashier & Kitchen", price: "$14.99/mo", cta: "Start Trial" },
      operations: { name: "Operations", tagline: "Full Ops Stack", price: "$29.99/mo", cta: "Start Trial" },
      enterprise: { name: "Enterprise", tagline: "Multi-Outlet", price: "Contact us", cta: "Contact Sales" },
    },
    freeTier: {
      badge: "FREE — Forever",
      ...
      feat1: { title: "Digital Menu Page", desc: "Create a public page with your menu, photos, and prices. Customers open it on any phone, no app required." },
      feat2: { title: "QR Code & Shareable Link", desc: "One link for your Instagram bio, WhatsApp, or print as a physical QR code for your tables." },
      feat3: { title: "Online Ordering", desc: "Customers browse your menu and send orders directly from their phone to your kitchen or cashier." },
      feat4: { title: "QRIS & Digital Payments", desc: "Accept payments via QRIS, GoPay, OVO, DANA, or bank transfer. Automatically confirmed." },
      feat5: { title: "Unlimited Product Catalog", desc: "Add products, categories, photos, prices, and descriptions. No limit on the number of products." },
      feat6: { title: "Basic Dashboard", desc: "Monitor incoming orders and their latest status from a clean, simple dashboard." },
    },
    posTier: {
      badge: "POS Plan",
      ...
      feat1: { title: "Point of Sale Interface", desc: "A fast and intuitive cashier interface for processing in-venue transactions quickly and accurately." },
      feat2: { title: "Kitchen Display System (KDS)", desc: "Real-time order display in the kitchen. Kitchen staff instantly know what to prepare." },
      feat3: { title: "Table Management", desc: "Manage table layouts, status, and per-table orders. Perfect for dine-in restaurants." },
      feat4: { title: "Thermal Receipt Printing", desc: "Print receipts automatically to a thermal printer in professional format with your business logo." },
      feat5: { title: "Order Management", desc: "Monitor all orders — dine-in, takeaway, and online — in one unified view." },
      feat6: { title: "Offline Mode", desc: "POS continues to work even when the internet connection is temporarily unavailable." },
    },
    operationsTier: {
      ...
      feat1: { title: "Staff & Shift Management", desc: "Schedule shifts, track attendance, and monitor staff performance. Shift data stored neatly for payroll." },
      feat2: { title: "Recipe & COGS Calculation", desc: "Enter your menu recipes and Epidom automatically calculates the Cost of Goods Sold (COGS) per item." },
      feat3: { title: "Inventory Management", desc: "Track raw material stock in real-time. Every POS transaction automatically deducts inventory." },
      feat4: { title: "Stock & Expiry Alerts", desc: "Automatic notifications when stock approaches its minimum level or ingredients are near their expiry date." },
      feat5: { title: "Supplier Management", desc: "Store supplier data, purchase history, and compare prices between suppliers over time." },
      feat6: { title: "Operational Reports", desc: "Daily, weekly, and monthly reports for sales, stock usage, and operational costs." },
    },
    enterpriseTier: {
      ...
      feat1: { title: "Multi-Outlet Management", desc: "Manage multiple outlets from one centralized dashboard. Each outlet's data is separate and secure." },
      feat2: { title: "Financial Reports", desc: "Complete financial reports: P&L, cash flow, and margin analysis per menu item." },
      feat3: { title: "Owner Dashboard", desc: "A dedicated dashboard for business owners with a performance summary across all outlets." },
      feat4: { title: "Role-Based Access Control", desc: "Set staff access rights per outlet. Managers can only access data from their respective outlet." },
      feat5: { title: "Priority Support", desc: "Dedicated account manager and priority support with a 2-business-hour response guarantee." },
      feat6: { title: "Custom Integration", desc: "API access and custom integrations with your existing systems — accounting, ERP, or delivery platforms." },
    },
    serviceCta: {
  ...
  about: {
    ...
    stat1label: "Active businesses",   stat1value: "500+",
    stat2label: "Orders processed",    stat2value: "10k+/day",
    stat3label: "Countries",           stat3value: "20+",
    stat4label: "Avg. user rating",    stat4value: "4.9 ★",
    valuesEyebrow: "What we believe",
    v1title: "Calm by default",      v1body: "Good software doesn't create noise. Epidom sends one WhatsApp ping per order and one email per night. That's it.",
    v2title: "Built for real kitchens", v2body: "Every screen was designed while standing behind a counter. If it needs a manual, we redesign it.",
    v3title: "Transparent pricing",  v3body: "Free really means free. No surprise fees, no dark patterns. We grow when you grow.",
    teamEyebrow: "The team",
    teamTitle: "A small crew, a real focus.",
    teamBody: "We're a product team of six, based across Indonesia and France. We work on one thing: making F&B ownership less stressful.",
  ...
  redesign: {
    hero: {
      ...
      proof1Val: "500+", proof1Label: "Active businesses",
      proof2Val: "20+",  proof2Label: "Countries",
      proof3Val: "10k+", proof3Label: "Orders / day",
      proof4Val: "4.9",  proof4Label: "From users",
    ...
    oneLink: {
      ...
      step1n: "01", step1t: "Customer opens your link",
      step1b: "Shared in IG bio, WA broadcast, table QR — it all goes to one branded menu page.",
      step2n: "02", step2t: "They order + pay (QRIS)",
      step2b: "QRIS, GoPay, OVO, bank transfer or card. No app to install, opens straight in the browser.",
      step3n: "03", step3t: "You get a WhatsApp ping",
      step3b: "Order lands on your KDS, thermal receipt prints, and the daily report updates in the background.",
    },
    oldVsNew: {
    ...
    coreProducts: {
      ...
      p1body: "A branded menu page with a QR code and a shareable URL. Drop it in your IG story, print it for the table, send it on WhatsApp.",
      p2tag: "02 · Accept Orders",
      p2title1: "Every wallet,",
      p2title2: "one checkout.",
      p2body: "QRIS, GoPay, OVO, bank transfer, card. Customers don't install anything. You get the WhatsApp ping the moment they pay.",
      ...
      p3body: "Run POS on a phone or tablet, push tickets to the KDS, and print thermal receipts in one tap. Shift handovers stop being a mystery.",
    ...
    features: {
      ...
      f1title: "IG-ready menus",     f1body: "A branded menu page with your logo, hero photo and QR. Built to live in your Instagram bio.",     f1hint: "Custom URL · custom theme",
      f2title: "Table QR + dine-in", f2body: "Print one QR per table. Customers scan, order, pay — kitchen prints automatically.",              f2hint: "Works on any phone",
      f3title: "Multi-payment",      f3body: "QRIS, GoPay, OVO, bank transfer, card, cash. One checkout, one settlement.",                       f3hint: "0.7% transaction fee",
      f4title: "POS + KDS",          f4body: "A phone, a tablet or a real terminal. Tickets push to the kitchen display in real-time.",          f4hint: "Thermal receipts supported",
      f5title: "Recipes & COGS",     f5body: "Define a recipe once; every sale deducts ingredients. Daily COGS per item, automatically.",         f5hint: "Stock alerts included",
      f6title: "Daily reports",      f6body: "Sales, COGS, top movers, shift cash-out — emailed every night, exportable to PDF/CSV.",            f6hint: "Owner-friendly summaries",
      f7title: "WhatsApp business",  f7body: "Order notifications, ready-pings to customers, broadcast new menus — all from one number.",        f7hint: "Official WA API",
      f8title: "Multi-outlet",       f8body: "Run two or twenty shops. Shared recipes, per-outlet stock, one consolidated dashboard.",           f8hint: "Owner dashboard",
    },
    dashboard: {
    ...
    useCases: {
      ...
      cafe_body: "A clean menu page, table QRs, espresso-machine-friendly POS and milk/bean tracking. Open shift to close shift in one tab.",
      cafe_stat1v: "+34%", cafe_stat1l: "orders via IG link",
      cafe_stat2v: "4 min", cafe_stat2l: "shift handover",
      cafe_quote: "\"Customers now view my menu and order from Instagram. WhatsApp orders dropped massively.\"",
      cafe_by: "Sari Dewi · Coffee Shop, Bandung",
      restaurant_headline: "For the resto with 12 tables and a tired owner.",
      restaurant_body: "Table-side QR ordering, KDS in the kitchen, thermal receipts at the pass, staff & shifts on the side. Recipes drive your COGS.",
      restaurant_stat1v: "−28%", restaurant_stat1l: "kitchen wait time",
      restaurant_stat2v: "0",    restaurant_stat2l: "lost paper tickets",
      restaurant_quote: "\"Setup took 10 minutes and I could immediately share the link with customers. QRIS worked instantly.\"",
      restaurant_by: "Budi Santoso · Café Owner, Yogyakarta",
      cookie_headline: "For the cookie bar that lives or dies by the weekend.",
      cookie_body: "Daily bake board, walk-in counts, rush-mode alerts and a wholesale order portal for the cafés down the street.",
      cookie_stat1v: "+27%", cookie_stat1l: "weekend revenue",
      cookie_stat2v: "−38%", cookie_stat2l: "flour waste",
      cookie_quote: "\"We used to bake 800 and toss 200. Now we bake 720 and sell out by 5pm. Every weekend.\"",
      cookie_by: "Léa · Cookie Atelier, Bordeaux",
      warung_headline: "For the warung that grew faster than the spreadsheet.",
      warung_body: "Daily cash-out, simple item-level COGS, WhatsApp-first communication and a free-forever tier so you can start today.",
      warung_stat1v: "0",    warung_stat1l: "mystery cash gaps",
      warung_stat2v: "Free", warung_stat2l: "forever, on menu + orders",
      warung_quote: "\"Automatic daily reports tell me exactly how much I made. I used to calculate manually.\"",
    ...
    pricingTeaser: {
      ...
      t1tag: "Free forever", t1name: "Free",       t1price: "$0",     t1period: "forever",     t1desc: "Menu page + online orders + QR — 1 outlet.",
      t2tag: "For dine-in",  t2name: "POS",        t2price: "$14.99", t2period: "per month",   t2desc: "Add POS, KDS, table management, thermal receipts.",
      t3tag: "Most popular", t3name: "Operations", t3price: "$29.99", t3period: "per month",   t3desc: "Add staff & shifts, recipes & COGS, auto stock alerts, daily reports.",
      t4tag: "Multi-outlet", t4name: "Enterprise", t4price: "Custom", t4period: "talk to us",  t4desc: "Multi-outlet & owner dashboard, full financial reports, dedicated support.",
      seeplan: "See plan →",
    },
    faq: {
      eyebrow: "FAQ",
    ...
    servicesPage: {
      ...
      script: "Five modules, one source of truth, and a kitchen-friendly UI that does not pretend you have an IT department.",
      r1eyebrow: "01 · Menu",
      r1title: "Your bio link, now a fully-running store.",
      r1body: "A branded menu page with your logo, hero photo, categories and items. Customers don't install anything — it opens straight in the browser. One URL goes everywhere.",
      ...
      r2body: "QRIS, GoPay, OVO, bank transfer, card, cash — your customer picks. Settlement is next-day. You get a WhatsApp ping the moment they pay.",
      ...
      r3body: "Run POS on a phone, tablet or proper terminal. Tickets push to the kitchen display the moment they're paid. Thermal receipts print in one tap.",
      ...
      r4body: "Define a recipe once and Epidom figures out the rest — portion cost, allergen labels, batch yield, automatic stock deductions every time the recipe sells.",
      ...
      r5body: "Sales, COGS, top movers, shift cash-out — emailed every night, exportable to PDF/CSV. Owner-friendly summaries that your accountant will say thank you for.",
    ...
    pricingPage: {
      ...
      trialBarSub: "No card. We import your existing menu for free. Cancel any time, your data leaves with you.",
      ...
      mostPopular: "Most popular",
      t1tag: "Free forever", t1name: "Free",       t1tagline: "Get your menu page online today. Forever free.",        t1price_mo: "$0",     t1price_yr: "$0",     t1cta: "Start free",
      t2tag: "For dine-in",  t2name: "POS",        t2tagline: "For dine-in cafés & restaurants.",                       t2price_mo: "$14.99", t2price_yr: "$12.49", t2cta: "Start free trial",
      t3tag: "Most popular", t3name: "Operations", t3tagline: "For shops with staff, recipes & growth ambitions.",       t3price_mo: "$29.99", t3price_yr: "$24.99", t3cta: "Start free trial",
      t4tag: "Multi-outlet", t4name: "Enterprise", t4tagline: "For multi-outlet owners & franchises.",                   t4price_mo: "Custom", t4price_yr: "Custom", t4cta: "Talk to us",
      t1f1: "Menu page + QR code",            t1f2: "Online orders (any device)",        t1f3: "QRIS / bank transfer payments",
      t1f4: "WhatsApp notifications",          t1f5: "1 outlet",                          t1f6: "POS + KDS",
      t1f7: "Recipes & COGS",                  t1f8: "Multi-outlet dashboard",
      t2f1: "Everything in Free",              t2f2: "POS on any device",                 t2f3: "KDS for kitchen",
      t2f4: "Table management + QRs",          t2f5: "Thermal receipt printing",          t2f6: "GoPay / OVO / card / cash",
      t2f7: "Recipes & COGS",                  t2f8: "Multi-outlet dashboard",
      t3f1: "Everything in POS",               t3f2: "Staff & shift management",          t3f3: "Recipes & COGS engine",
      t3f4: "Auto stock + alerts",             t3f5: "Daily P&L emailed to owner",        t3f6: "Allergen + nutrition labels",
      t3f7: "Wholesale order portal",          t3f8: "Multi-outlet dashboard",
      t4f1: "Everything in Operations",        t4f2: "Multi-outlet & owner dashboard",    t4f3: "Centralised recipe library",
      t4f4: "Full financial reports",          t4f5: "API + Zapier + webhooks",           t4f6: "SSO + advanced roles",
      t4f7: "Dedicated account manager",       t4f8: "Custom SLAs",
      ...
      cmpCat1: "Menu & Orders",     cmpCat2: "Payments",   cmpCat3: "POS & Kitchen",  cmpCat4: "Stock & Reports",
      cmp_menu_items: "Menu items",                 cmp_qr: "QR code generator",
      cmp_branding: "Custom branding",             cmp_multilingual: "Multilingual menus",
      cmp_qris: "QRIS / bank transfer",            cmp_gopay: "GoPay / OVO / card",
      cmp_wa: "WhatsApp notifications",            cmp_fee: "Transaction fee",
      cmp_phone_pos: "Phone / tablet POS",         cmp_kds: "KDS",
      cmp_thermal: "Thermal printers",             cmp_staff: "Staff & shifts",
