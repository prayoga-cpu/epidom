export const en = {
  ...
  profile: {
    ...
    accountSettings: {
      ...
      deleteDescription: "This is permanent. All your stores, products, orders, and data will be deleted and cannot be recovered.",
  ...
  billing: {
    ...
    notStripeManaged: "You're on the Free plan — there's no payment method or subscription to manage. Upgrade to unlock paid features.",
    betaAccount: "BETA account — admin-granted access with no payment method. Switch to any plan instantly.",
  ...
  import: {
    title: "Smart Import",
    subtitle: "Bring your old data in — import a CSV or spreadsheet straight into your dashboard, and our AI maps the columns for you.",
    steps: {
      upload: "Upload",
      analysis: "Analysis",
      preview: "Preview",
  ...
  publicOrder: {
    ...
    orderStatus: {
      ...
      ewalletDesc: "You should be redirected to the payment page. If you haven't paid, please try ordering again.",
