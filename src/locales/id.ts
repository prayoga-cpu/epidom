export const id = {
  ...
  profile: {
    ...
    accountSettings: {
      ...
      deleteDescription: "Tindakan ini permanen. Semua toko, produk, pesanan, dan data Anda akan dihapus dan tidak dapat dikembalikan.",
  ...
  billing: {
    ...
    notStripeManaged: "Anda berada di paket gratis — tidak ada metode pembayaran atau langganan untuk dikelola. Tingkatkan untuk membuka fitur berbayar.",
    betaAccount: "Akun BETA — akses dari admin tanpa metode pembayaran. Ganti ke paket apa pun secara instan.",
  ...
  import: {
    title: "Impor Cerdas",
    subtitle: "Bawa data lama Anda — impor file CSV atau spreadsheet langsung ke dashboard, dan AI kami memetakan kolomnya untuk Anda.",
    steps: {
      upload: "Upload",
      analysis: "Analisis",
      preview: "Pratinjau",
  ...
  publicOrder: {
    ...
    orderStatus: {
      ...
      ewalletDesc: "Anda seharusnya dialihkan ke halaman pembayaran. Jika belum bayar, silakan coba pesan ulang.",
  ...
  about: {
    ...
    stat4label: "Rating pengguna",    stat4value: "4,9/5",
  ...
  storefront: {
    ...
    settings: {
      ...
      heroGuide: "Banner · ideal 1920×1080 px (16:9) · min 1200×675 px · maks 5 MB · JPEG atau WebP",
