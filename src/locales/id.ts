export const id = {
  ...
  profile: {
    ...
    accountSettings: {
      ...
      accountDeleted: "Akun dihapus. Sedang keluar...",
      passwordsDoNotMatch: "Kata sandi tidak cocok",
      ...
      deleteDescription:
        "Tindakan ini permanen. Semua toko, produk, pesanan, dan data Anda akan dihapus dan tidak dapat dikembalikan.",
      confirmEmailLabel: "Ketik email Anda {email} untuk mengonfirmasi",
      deleteConfirmButton: "Hapus Akun Saya",
    },
  },
  stores: {
    title: "Toko Anda",
  ...
  redesign: {
    ...
    pricingPage: {
      ...
      t1f6: "POS + KDS",
      t1f7: "Resep & HPP",
      t1f8: "Dashboard multi-outlet",
      t2f1: "Semua di paket Gratis",
      t2f2: "POS di perangkat apa pun",
      t2f3: "KDS untuk dapur",
      t2f4: "Manajemen meja + QR",
      t2f5: "Cetak struk termal",
      t2f6: "GoPay / OVO / kartu / tunai",
      t2f7: "Resep & HPP",
      t2f8: "Dashboard multi-outlet",
      t3f1: "Semua di paket POS",
      t3f2: "Manajemen staf & shift",
      t3f3: "Mesin resep & HPP",
      t3f4: "Stok otomatis + peringatan",
      t3f5: "L/R harian dikirim ke pemilik",
      t3f6: "Label alergen + nutrisi",
      t3f7: "Portal pesanan grosir",
      t3f8: "Dashboard multi-outlet",
      t4f1: "Semua di paket Operations",
      t4f2: "Dashboard multi-outlet & pemilik",
      t4f3: "Perpustakaan resep terpusat",
      t4f4: "Laporan keuangan lengkap",
      t4f5: "API + Zapier + webhook",
