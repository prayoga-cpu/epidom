export const id = {
  ...
  home: {
    ...
    whatYouGet: {
      ...
      subheadline:
        "Pelanggan buka link kamu → lihat menu → pesan → bayar QRIS. Kamu terima notif WA. Selesai.",
      feature1Title: "Halaman Menu",
      feature1Desc:
        "QR code + link shareable ke IG story. Pelanggan bisa lihat menu dan pesan kapan saja.",
    ...
    featureLadder: {
      ...
      subheadline:
        "Dari warung kecil hingga franchise — ada paket yang cocok untuk setiap tahap bisnis kamu.",
      popular: "Populer",
    ...
    testimonials: {
      ...
      t1Quote:
        "Sekarang pelanggan bisa lihat menu dan pesan dari Instagram. Pesanan WA saya berkurang drastis!",
      t2Name: "Budi Santoso",
      t2Role: "Owner Kafe, Yogyakarta",
      t2Quote:
        "Setup cuma 10 menit dan langsung bisa share link ke pelanggan. QRIS langsung jalan, mantap.",
      t3Name: "Rina Kusuma",
      t3Role: "Resto Rumahan, Surabaya",
      t3Quote:
        "Laporan harian otomatis bikin saya tahu persis berapa untung tiap hari. Dulu harus hitung manual.",
      ratingBadge: "4.9/5 dari pengguna Epidom",
    },
    painGain: {
  ...
  services: {
    ...
    tiers: {
      ...
      free: {
        name: "FREE",
        tagline: "Storefront & Pesanan Online",
        price: "Rp 0",
        cta: "Mulai Gratis",
      },
    ...
    freeTier: {
      ...
      feat1: {
        title: "Halaman Menu Digital",
        desc: "Buat halaman publik dengan menu, foto, dan harga. Pelanggan buka dari HP mana pun tanpa install app.",
      },
      feat2: {
        title: "QR Code & Link Shareable",
        desc: "Satu link untuk bio Instagram, WhatsApp, atau cetak sebagai QR code fisik untuk meja kamu.",
      },
      feat3: {
        title: "Terima Pesanan Online",
        desc: "Pelanggan pilih menu dan kirim pesanan langsung dari HP mereka ke dapur atau kasir kamu.",
      },
      feat4: {
        title: "Pembayaran QRIS & Digital",
        desc: "Terima pembayaran via QRIS, GoPay, OVO, DANA, atau transfer bank. Otomatis terkonfirmasi.",
      },
      feat5: {
        title: "Katalog Produk Unlimited",
        desc: "Tambah produk, kategori, foto, harga, dan deskripsi. Tidak ada batasan jumlah produk.",
      },
      feat6: {
        title: "Dashboard Dasar",
        desc: "Pantau pesanan masuk dan status terbaru dari dashboard yang bersih dan sederhana.",
      },
    },
    posTier: {
      badge: "Paket POS",
      ...
      feat1: {
        title: "Antarmuka Point of Sale",
        desc: "Antarmuka kasir yang cepat dan intuitif untuk memproses transaksi di tempat dengan cepat dan akurat.",
      },
      feat2: {
        title: "Kitchen Display System (KDS)",
        desc: "Tampilan pesanan di dapur secara real-time. Staf dapur langsung tahu apa yang harus disiapkan.",
      },
      feat3: {
        title: "Manajemen Meja",
        desc: "Atur tata letak meja, status, dan pesanan per meja. Cocok untuk restoran dine-in.",
      },
      feat4: {
        title: "Cetak Struk Thermal",
        desc: "Cetak struk otomatis ke printer thermal dalam format profesional dengan logo bisnis kamu.",
      },
      feat5: {
        title: "Manajemen Pesanan",
        desc: "Pantau semua pesanan — dine-in, takeaway, dan online — dalam satu tampilan terpadu.",
      },
      feat6: {
        title: "Mode Offline",
        desc: "Kasir tetap bisa digunakan meski koneksi internet putus sementara.",
      },
    },
    operationsTier: {
      ...
      feat1: {
        title: "Manajemen Staf & Shift",
        desc: "Atur jadwal shift, lacak kehadiran, dan pantau kinerja staf. Data shift tersimpan rapi untuk penggajian.",
      },
      feat2: {
        title: "Resep & Kalkulasi HPP",
        desc: "Input resep menu kamu, Epidom otomatis hitung Harga Pokok Produksi (HPP) per item.",
      },
      feat3: {
        title: "Manajemen Stok",
        desc: "Lacak stok bahan baku secara real-time. Setiap transaksi POS otomatis mengurangi stok.",
      },
      feat4: {
        title: "Alert Stok & Expired",
        desc: "Notifikasi otomatis saat stok mendekati batas minimum atau bahan mendekati tanggal kedaluwarsa.",
      },
      feat5: {
        title: "Manajemen Supplier",
        desc: "Simpan data supplier, histori pembelian, dan bandingkan harga antar supplier dari waktu ke waktu.",
      },
      feat6: {
        title: "Laporan Operasional",
        desc: "Laporan harian, mingguan, dan bulanan untuk penjualan, penggunaan stok, dan biaya operasional.",
      },
    },
    enterpriseTier: {
      ...
      feat1: {
        ...
        desc: "Kelola banyak outlet dari satu dashboard terpusat. Data tiap outlet terpisah dan aman.",
      },
      feat2: {
        title: "Laporan Keuangan",
        desc: "Laporan keuangan lengkap: laba rugi, arus kas, dan analisa margin per item menu.",
      },
      feat3: {
        title: "Owner Dashboard",
        desc: "Dashboard khusus pemilik bisnis dengan ringkasan kinerja semua outlet.",
      },
      feat4: {
        title: "Manajemen Akses Berbasis Peran",
        desc: "Atur hak akses staf per outlet. Manager hanya bisa mengakses data outlet mereka.",
      },
      feat5: {
        title: "Dukungan Prioritas",
        desc: "Account manager khusus dan dukungan prioritas dengan jaminan respons dalam 2 jam kerja.",
      },
      feat6: {
        title: "Integrasi Kustom",
        desc: "Akses API dan integrasi kustom dengan sistem yang sudah ada — akuntansi, ERP, atau platform delivery.",
      },
    },
    serviceCta: {
...
lifetime: "Akses seumur hidup",
  ...
  publicOrder: {
    ...
    orderStatus: {
      ...
      desc: {
        PENDING: "Pesanan kamu sedang menunggu konfirmasi dari penjual.",
  ...
  pos: {
    ...
    orderCard: {
      ...
      cancelConfirmDesc: "Pesanan ini akan dibatalkan. Tindakan ini tidak dapat dibatalkan.",
      cancelConfirmDescDelivered:
        "Pesanan ini sudah terkirim — membatalkannya akan mengembalikan stoknya. Tindakan ini tidak dapat dibatalkan.",
  ...
  about: {
    ...
    teamBody:
      "Kami tim produk beranggotakan enam orang, berbasis di Indonesia dan Prancis. Kami fokus pada satu hal: membuat kepemilikan F&B lebih tenang.",
