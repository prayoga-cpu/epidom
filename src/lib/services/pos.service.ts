...
import type { CartItem, CheckoutResult } from "@/features/mvp/pos/types";
...
export class PosService {
   ...
   */
  async processCheckout(input: { storeId: string; items: CartItem[]; total: number }): Promise<CheckoutResult> {
   ...
   */
  async getProductsForPOS(storeId: string) {
   ...
   */
  async getTransactionCount(storeId: string): Promise<number> {
