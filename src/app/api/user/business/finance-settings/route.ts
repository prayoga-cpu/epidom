 ...
 * finance-settings.service.ts) — there's no separate "business" view in the
 * UI, so this is only ever written from a synced store's edit dialog.
 */
import { NextResponse } from "next/server";
import { businessService, updateBusinessFinanceSettings } from "@/lib/services";
